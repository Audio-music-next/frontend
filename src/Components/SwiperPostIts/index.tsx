    ...
    >
      ...
      {postIts.map((post) => (
        <SwiperSlide key={post.title}>
          <li
            key={post.title}
            className=" max-w-[200px] max-h-[220px] flex flex-col gap-2 rounded-radius-2 relative bg-random-1 p-4 pt-3 my-0 mx-auto min-[400px]:max-w-[240px] xl:mx-0:left-7"
          >
