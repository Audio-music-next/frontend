  ...
  return (
    <React.Fragment>
      <div
       ...
       bg-white/30  top-0 left-0 -z-10 dark:bg-black/30"
      />
      <div className="flex flex-col gap-6 text-gray-0 dark:text-gray-9 ">
        <h1 className="text-heading-3 font-600 ">
          Bem-vindo ao Palco da Essência Sonora!
        </h1>
        <p className="text-body-1 text-justify lg:max-w-[60%]">
